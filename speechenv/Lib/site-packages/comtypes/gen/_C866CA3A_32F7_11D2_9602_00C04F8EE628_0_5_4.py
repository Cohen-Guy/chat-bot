...
__all__ = [
    'SPSFunction', 'SpeechCategoryAudioOut', 'ISpeechMMSysAudio',
    'SAFTADPCM_11kHzMono', 'DISPID_SVSpeakStream',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SPRuleParent', 'SP_VISEME_1',
    'ISpeechAudioStatus', 'ISpPhraseAlt', 'DISPID_SPIAudioSizeTime',
    'SGPronounciation', 'DISPID_SRCBookmark', 'DISPID_SVSVisemeId',
    'SPWF_SRENGINE', 'DISPID_SDKEnumKeys',
    'DISPID_SRCEFalseRecognition', 'DISPID_SDKSetStringValue',
    'DISPID_SRSSupportedLanguages', 'SPPROPERTYINFO',
    'DISPID_SRAudioInputStream', 'DISPID_SPPsCount', 'SVSFPersistXML',
    'DISPID_SpeechAudioStatus', 'SRATopLevel', 'DISPID_SGRsAdd',
    'SVP_3', 'DISPID_SPANumberOfElementsInResult', 'SRERecognition',
    'SpeechSpecialTransitionType', 'DISPID_SpeechWaveFormatEx',
    'WAVEFORMATEX', 'DISPID_SpeechVoice', 'DISPID_SRCEInterference',
    'ISpeechFileStream', 'SSFMCreate', 'ISpRecoResult',
    'SPINTERFERENCE_TOOFAST', 'SPGS_DISABLED', 'SAFTText',
    'ISpeechLexiconPronunciation', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SWFEAvgBytesPerSec', 'SINone', 'DISPID_SVVoice',
    '_RemotableHandle', 'SVPNormal', 'DISPID_SPEAudioSizeTime',
    'DISPID_SRCEHypothesis', 'SPVPRI_ALERT', 'SPWORDLIST',
    'DISPID_SRGCmdLoadFromFile', 'SPCT_SUB_COMMAND',
    'DISPID_SVVolume', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SVSPhonemeId', 'DISPID_SPPs_NewEnum',
    'DISPID_SRRAlternates', 'DISPID_SpeechPhraseRules',
    'DISPID_SLWsCount', 'SpFileStream', 'SAFT12kHz16BitStereo',
    'DISPID_SRCEBookmark', 'SPSSuppressWord',
    'ISpPhoneticAlphabetSelection', 'DISPID_SGRs_NewEnum',
    'DISPID_SVEventInterests', 'SFTInput', 'SPRS_ACTIVE',
    'SRSInactive', 'DISPID_SOTIsUISupported',
    'DISPID_SOTGetStorageFileName', 'SPVPRI_OVER',
    'DISPID_SpeechObjectToken', 'SpeechAudioFormatGUIDWave',
    'ISpNotifyTranslator', 'DISPID_SRCEPropertyNumberChange',
    'ISpeechMemoryStream', 'SDTAlternates', 'STCInprocServer',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SDTAll', 'SITooFast',
    'DISPID_SpeechPhraseReplacement', 'ISpeechRecoContext',
    'SAFT8kHz8BitMono', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SVDisplayUI', 'SVP_14', 'DISPID_SASetState', 'SVP_12',
    'SPSHT_EMAIL', 'ISpSerializeState', 'SVEEndInputStream',
    'SPINTERFERENCE_NOSIGNAL', 'SPXMLRESULTOPTIONS',
    'DISPID_SPRs_NewEnum', 'DISPID_SPILanguageId',
    'DISPID_SLWs_NewEnum', 'SPEI_RESERVED6',
    'DISPID_SPIGetDisplayAttributes', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRCEventInterests', 'DISPID_SOTCDefault',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SGRSTText', 'SAFT48kHz16BitMono',
    'SPPHRASE', 'DISPID_SAVolume', 'SPEI_ADAPTATION',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SLPsCount',
    'DISPID_SVAudioOutput', 'SpeechEngineConfidence',
    'ISpeechPhraseAlternate', 'SPEI_MAX_TTS', 'DISPID_SRRPhraseInfo',
    'DISPID_SRCCreateResultFromMemory', 'SPXRO_Alternates_SML',
    'SWTAdded', 'SPAUDIOSTATE', '_ISpeechVoiceEvents',
    'SAFT44kHz8BitMono', 'DISPID_SGRName',
    'DISPID_SLAddPronunciation', 'DISPID_SVEStreamEnd',
    'DISPID_SOTCSetId', 'SPPS_RESERVED3', 'SPINTERFERENCE_TOOQUIET',
    'SSFMCreateForWrite', 'DISPID_SRGRecoContext', 'SPXRO_SML',
    'SPRST_NUM_STATES', 'DISPID_SWFEExtraData',
    'SGDSActiveWithAutoPause', 'SAFT32kHz16BitStereo', 'SPBO_AHEAD',
    'DISPID_SVPriority', 'DISPID_SBSWrite', 'SPSHT_OTHER',
    'DISPID_SLPs_NewEnum', 'DISPID_SRCERecognitionForOtherContext',
    'SAFT44kHz8BitStereo', '__MIDL_IWinTypes_0009',
    'DISPID_SPERetainedStreamOffset',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SMSSetData',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPELexicalForm',
    'SPEI_END_INPUT_STREAM', 'SVP_17', 'SAFT24kHz16BitMono',
    'DISPID_SpeechPhraseInfo', 'SpTextSelectionInformation',
    'DISPID_SDKEnumValues', 'DISPID_SFSOpen', 'ISpStream',
    'DISPID_SDKGetlongValue', 'ISpeechPhraseElement',
    'SECFNoSpecialChars', 'DISPID_SPIRetainedSizeBytes', 'SpVoice',
    'DISPID_SGRId', 'SPEVENT', 'DISPID_SpeechObjectTokens',
    'SDTPronunciation', 'SpeechVisemeType', 'SPEI_END_SR_STREAM',
    'DISPID_SVSInputSentenceLength', 'SDKLCurrentConfig',
    'SVEAudioLevel', 'DISPID_SRRecognizer', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechPhraseElements', 'SSTTTextBuffer', 'SGDisplay',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRGId', 'SPLO_DYNAMIC',
    'DISPID_SRSetPropertyString', 'SRCS_Enabled',
    'SpeechTokenIdUserLexicon', 'SAFT8kHz16BitStereo',
    'DISPID_SMSALineId', 'DISPID_SREmulateRecognition',
    'SpeechWordType', 'SPWT_DISPLAY',
    'DISPID_SRSCurrentStreamPosition', 'SPEI_REQUEST_UI',
    'DISPID_SRCVoicePurgeEvent', 'SGSExclusive', 'eLEXTYPE_PRIVATE9',
    'SPAR_Medium', 'SPRECOGNIZERSTATUS', 'DISPID_SRCRecognizer',
    'SAFTGSM610_22kHzMono', 'SPAS_STOP', 'DISPID_SDKSetBinaryValue',
    'SVSFIsFilename', 'DISPID_SGRsCommitAndSave',
    'DISPID_SDKGetStringValue', 'SAFTADPCM_22kHzMono',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SPIGrammarId',
    'DISPID_SPPName', 'SVSFUnusedFlags', 'SPTEXTSELECTIONINFO',
    'SVEBookmark', 'SPINTERFERENCE_LATENCY_WARNING',
    'SAFTExtendedAudioFormat', 'SPFM_NUM_MODES', 'SREAllEvents',
    'SpPhoneConverter', 'DISPID_SRCESoundStart', 'SPCS_DISABLED',
    'ISpObjectWithToken', 'DISPID_SpeechPhraseProperties',
    'SpeechDiscardType', 'DISPID_SWFEBlockAlign',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SpeechAudio',
    'SAFTDefault', 'ISpRecoCategory', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SPEs_NewEnum', 'SPEI_MIN_SR', 'eLEXTYPE_PRIVATE11',
    'SpeechAddRemoveWord', 'DISPID_SPEEngineConfidence',
    'SPEI_SR_RETAINEDAUDIO', 'eLEXTYPE_RESERVED4',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SLTApp', 'SAFT44kHz16BitStereo',
    'DISPID_SLGenerationId', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SPACommit', 'DISPID_SGRsItem', 'SAFT11kHz8BitStereo',
    'DISPID_SPRDisplayAttributes', 'DISPID_SGRSAddWordTransition',
    'DISPID_SASCurrentDevicePosition', 'SPAR_Unknown', 'SITooQuiet',
    'DISPID_SGRInitialState', 'SVP_5', 'SpeechEmulationCompareFlags',
    'SDKLCurrentUser', 'SLODynamic', 'STCLocalServer',
    'DISPID_SAEventHandle', 'SpeechPartOfSpeech', 'DISPID_SVSpeak',
    'Speech_Max_Pron_Length', 'SDKLLocalMachine',
    'DISPID_SRGetPropertyString', 'SP_VISEME_15',
    'SAFTNonStandardFormat', 'eLEXTYPE_PRIVATE1', 'SREInterference',
    'SPCT_SUB_DICTATION', 'DISPID_SVEViseme', 'SP_VISEME_8',
    'SpeechCategoryPhoneConverters', 'SVP_4',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SPIStartTime',
    'eWORDTYPE_DELETED', 'SpSharedRecognizer',
    '_ISpeechRecoContextEvents', 'SAFT16kHz16BitStereo',
    'DISPID_SVGetAudioOutputs',
    'DISPID_SLRemovePronunciationByPhoneIds', 'IStream',
    'DISPID_SPEDisplayText', 'SP_VISEME_14', 'SECFDefault',
    'SSSPTRelativeToEnd', 'DISPID_SpeechRecoResult2',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SpeechLexiconWords',
    'SRTAutopause', 'SGDSActive', 'DISPID_SPPConfidence',
    'ISpEventSource', 'DISPID_SRGCommit', 'SRADynamic', 'SPRULE',
    'SpMMAudioIn', 'DISPID_SRGetFormat',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SGRAddResource',
    'SGRSTTDictation', 'DISPID_SPPValue', 'ISpeechPhraseRules',
    'STSF_FlagCreate', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRRSetTextFeedback', 'SPPS_Noncontent',
    'DISPIDSPTSI_ActiveOffset', 'ISpeechVoiceStatus',
    'DISPID_SAFGuid', 'SPRS_ACTIVE_USER_DELIMITED', 'SVP_21',
    'DISPID_SGRSTPropertyValue', 'eLEXTYPE_PRIVATE8', 'SVP_15',
    'DISPID_SRGetPropertyNumber', 'SAFT11kHz16BitMono',
    'DISPID_SADefaultFormat', 'SGSEnabled', 'SDA_One_Trailing_Space',
    'DISPID_SGRsDynamic', 'DISPID_SPAsCount',
    'SpeechPropertyAdaptationOn', 'SBONone', 'DISPID_SGRsFindRule',
    'DISPID_SVGetVoices', 'SpeechDictationTopicSpelling',
    'SP_VISEME_0', 'SPAUDIOOPTIONS', 'DISPID_SPERetainedSizeBytes',
    'SVSFNLPMask', 'SPLOADOPTIONS', 'ISpeechLexiconPronunciations',
    'SpeechRuleState', 'SPSInterjection', 'ISequentialStream',
    'SpeechRecoProfileProperties', 'SpeechEngineProperties',
    'SECFIgnoreCase', 'ISpRecognizer3', 'SPEI_TTS_PRIVATE',
    'DISPID_SRState', 'DISPID_SVEPhoneme', 'DISPID_SVGetAudioInputs',
    'DISPID_SRGReset', 'SPWORDTYPE', 'DISPID_SLWType',
    'SPRECOCONTEXTSTATUS', 'ISpeechLexiconWords', 'SPWAVEFORMATTYPE',
    'DISPID_SOTMatchesAttributes', 'SECHighConfidence',
    'SAFT32kHz8BitStereo', 'DISPID_SpeechRecoResultTimes',
    'SREBookmark', 'ISpShortcut', 'ISpeechRecognizerStatus',
    'SPAR_Low', 'DISPID_SPEAudioSizeBytes', 'DISPID_SDKOpenKey',
    'ISpEventSink', 'DISPID_SRCEEnginePrivate', 'DISPID_SOTDataKey',
    'eLEXTYPE_PRIVATE10', 'SPEI_TTS_BOOKMARK', 'SPEI_MIN_TTS',
    'DISPID_SRGDictationLoad', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SPRNumberOfElements', 'SSTTDictation',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SASNonBlockingIO', 'SVP_7', 'ISpRecoGrammar2',
    'SPEI_START_SR_STREAM', 'DISPID_SWFEFormatTag',
    'DISPID_SpeechPhoneConverter', 'DISPID_SOTGetDescription',
    'SPEI_SOUND_END', 'ISpeechRecoResult2', 'SVSFParseAutodetect',
    'ISpGrammarBuilder', 'SPBINARYGRAMMAR',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SOTId', 'eLEXTYPE_USER',
    'SPDKL_CurrentUser', 'eLEXTYPE_RESERVED9',
    'DISPID_SRCSetAdaptationData', 'SPCATEGORYTYPE', 'SVP_9',
    'SPEI_VISEME', 'SP_VISEME_9', 'ISpeechWaveFormatEx',
    'DISPID_SOTsCount', 'SPEI_RESERVED3',
    'DISPID_SRCEPropertyStringChange', 'SDTProperty',
    'SREPhraseStart', 'ISpResourceManager', 'eLEXTYPE_PRIVATE3',
    'DISPID_SRProfile', 'DISPID_SVEWord', 'SP_VISEME_18',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SVSpeakCompleteEvent', 'SP_VISEME_17',
    'SpCompressedLexicon', 'ISpeechRecoGrammar', 'STCAll',
    'DISPID_SGRSTWeight', 'SVEAllEvents', 'ISpeechRecognizer',
    'DISPID_SGRsCount', 'SDTLexicalForm',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SpeechPhraseProperty',
    'DISPID_SPEActualConfidence', 'SPEI_RECOGNITION',
    'SAFT24kHz8BitStereo', 'DISPID_SRGCmdLoadFromObject',
    'SpeechRegistryLocalMachineRoot', 'SECFIgnoreWidth',
    'DISPID_SRRSpeakAudio', 'ISpeechTextSelectionInformation',
    'DISPID_SPRuleId', 'DISPID_SVRate', 'DISPID_SRIsShared',
    'STCInprocHandler', 'DISPID_SGRClear', 'SPPS_SuppressWord',
    'DISPID_SRCEStartStream', 'SREPrivate', 'SPSLMA',
    'DISPID_SRSAudioStatus', 'SPWT_PRONUNCIATION', 'DISPID_SGRSTType',
    'SRTExtendableParse', 'SINoise', 'DISPID_SVIsUISupported',
    'SBOPause', 'DISPID_SRRTTickCount', 'DISPID_SPPFirstElement',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SpeechPhraseBuilder',
    'SVSFIsXML', 'DISPID_SRGCmdLoadFromMemory', 'ISpeechVoice',
    'ISpPhoneConverter', 'SPRST_INACTIVE_WITH_PURGE',
    'SPEI_RECO_STATE_CHANGE', 'SREPropertyNumChange', 'SP_VISEME_21',
    'SGLexical', 'SPFM_OPEN_READONLY', 'SPRST_ACTIVE_ALWAYS',
    'SP_VISEME_6', 'DISPID_SGRsCommit', 'SGRSTTWord',
    'SPEI_SOUND_START', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRSCurrentStreamNumber', 'SVP_11',
    'SpeechCategoryRecognizers', 'ISpeechGrammarRule',
    'DISPID_SpeechGrammarRuleStateTransition', 'SpSharedRecoContext',
    'SDTDisplayText', 'DISPID_SRCreateRecoContext',
    'SPSEMANTICERRORINFO', 'eLEXTYPE_APP', 'SpStreamFormatConverter',
    'eLEXTYPE_LETTERTOSOUND', 'SAFT8kHz8BitStereo', 'SVP_10',
    'SAFT48kHz16BitStereo', 'DISPID_SGRAddState',
    'eLEXTYPE_RESERVED10', 'DISPID_SPIAudioSizeBytes',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechDataKey',
    'DISPID_SVStatus', 'SPEI_RESERVED5', 'eLEXTYPE_PRIVATE4',
    'SP_VISEME_3', 'DISPID_SDKSetLongValue', 'SAFT16kHz16BitMono',
    'DISPID_SPPParent', 'DISPID_SGRSTPropertyId', 'SAFT48kHz8BitMono',
    'SDTReplacement', 'DISPID_SAFSetWaveFormatEx',
    'SpeechWordPronounceable', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SpeechLexiconProns', 'DISPID_SPIProperties',
    'SpeechAllElements', 'DISPID_SPIRule', 'DISPID_SPAsItem',
    'SVPOver', 'DISPID_SPARecoResult', 'SAFTCCITT_uLaw_22kHzMono',
    'SPPHRASERULE', 'ISpeechXMLRecoResult', 'DISPID_SpeechLexicon',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SGRSTsCount',
    'SSSPTRelativeToStart', 'SpeechRecognitionType',
    'DISPID_SOTCGetDataKey', 'DISPID_SRGState',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'ISpeechPhraseProperties', 'SPSTREAMFORMATTYPE',
    'DISPID_SMSGetData', 'DISPID_SLWWord',
    'Speech_StreamPos_RealTime', 'SPSHORTCUTTYPE',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SGRSTNextState',
    'SSFMOpenForRead', 'SVEVoiceChange', 'SPFM_CREATE_ALWAYS',
    'SP_VISEME_19', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPGS_EXCLUSIVE', 'SPLEXICONTYPE', 'DISPID_SGRSTRule',
    'DISPID_SPIElements', 'SAFT11kHz16BitStereo',
    'SPEI_WORD_BOUNDARY', 'DISPID_SRStatus', 'STSF_LocalAppData',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpNotifySink', 'SPAR_High',
    'SpeechVoiceSpeakFlags', 'SPEI_INTERFERENCE',
    'DISPID_SpeechRecognizer', 'SDKLDefaultLocation',
    'IInternetSecurityMgrSite', 'SAFTADPCM_11kHzStereo',
    'ISpeechObjectToken', 'SpeechBookmarkOptions', 'SPVPRIORITY',
    'DISPID_SLGetWords', 'SP_VISEME_16',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SpeechRecoResult',
    'DISPID_SVSLastBookmarkId', 'SpResourceManager', 'SPWT_LEXICAL',
    'SITooLoud', 'ISpeechObjectTokenCategory', 'DISPID_SOTCId',
    'ISpeechAudio', 'tagSPTEXTSELECTIONINFO', 'SVPAlert',
    'SpeechStreamSeekPositionType', 'SAFTCCITT_uLaw_11kHzMono',
    'SPEI_SR_PRIVATE', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SVSInputSentencePosition', 'SPDKL_CurrentConfig',
    'ISpeechLexiconWord', 'SpeechAudioFormatGUIDText',
    'DISPID_SRIsUISupported', 'SVP_18', 'SECLowConfidence',
    'tagSTATSTG', 'DISPID_SRCAudioInInterferenceStatus', 'SRSActive',
    'SPPS_Modifier', 'SpMemoryStream', 'DISPID_SVWaitUntilDone',
    'DISPID_SPIGetText', 'SAFTCCITT_ALaw_44kHzMono',
    'SpeechVisemeFeature', 'DISPID_SLWsItem', 'SPSEMANTICFORMAT',
    'ISpeechPhraseReplacements', 'SPEI_RESERVED2',
    'DISPID_SVAlertBoundary', 'DISPID_SRCEAdaptation',
    'DISPID_SPRulesItem', 'eLEXTYPE_PRIVATE14', 'DISPID_SRRAudio',
    'DISPID_SpeechXMLRecoResult', 'SPDATAKEYLOCATION',
    'SpeechUserTraining', 'DISPID_SBSFormat',
    'DISPID_SRCEPhraseStart', 'DISPID_SVPause', 'SPBOOKMARKOPTIONS',
    'ISpLexicon', 'DISPID_SBSRead', 'SpeechRuleAttributes',
    'SGRSTTTextBuffer', 'SpNullPhoneConverter', 'SPPHRASEPROPERTY',
    'SAFTADPCM_8kHzStereo', 'DISPID_SpeechPhraseAlternate',
    'ISpNotifySource', 'DISPID_SpeechObjectTokenCategory',
    'SVSFParseSapi', 'SpeechAudioFormatType', 'DISPID_SPCLangId',
    'SRERequestUI', 'DISPID_SLPSymbolic',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SpeechBaseStream',
    'DISPID_SPIEngineId', 'SAFTADPCM_44kHzMono',
    'DISPID_SVSLastStreamNumberQueued', 'SpeechRecoContextState',
    'SPWF_INPUT', 'SPSNoun', 'DISPID_SpeechFileStream',
    'SPAO_RETAIN_AUDIO', 'DISPID_SPRsItem', 'SSTTWildcard',
    'DISPID_SPCIdToPhone', 'SVEPhoneme', 'DISPID_SPCPhoneToId',
    'SGDSInactive', 'eLEXTYPE_PRIVATE15', 'DISPID_SOTRemove',
    'DISPID_SGRSTPropertyName', 'DISPID_SPPId', 'SAFT16kHz8BitStereo',
    'DISPID_SRGSetWordSequenceData', 'SRESoundStart',
    'SPINTERFERENCE', 'DISPID_SVESentenceBoundary',
    'SpeechPropertyResourceUsage', 'SRAORetainAudio',
    'SpeechPropertyComplexResponseSpeed', 'SPINTERFERENCE_NONE',
    'ISpeechAudioFormat', 'DISPID_SGRSRule', 'ISpObjectToken',
    'Speech_Max_Word_Length', 'SRTSMLTimeout', 'SPEI_UNDEFINED',
    'DISPID_SRCEEndStream', 'SVP_20', 'DISPID_SVSRunningState',
    'SpeechDataKeyLocation', 'SPADAPTATIONRELEVANCE',
    'SAFT22kHz16BitStereo', 'SpeechTokenKeyAttributes',
    'DISPID_SpeechGrammarRules', 'DISPID_SPRuleNumberOfElements',
    'SPPS_Unknown', 'DISPID_SABufferInfo',
    'DISPID_SPIEnginePrivateData', 'DISPID_SOTCategory',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechRunState',
    'DISPID_SPAStartElementInResult', 'SRCS_Disabled',
    'DISPID_SpeechPhraseElement', 'DISPID_SABufferNotifySize',
    'ISpeechPhraseRule', 'SpPhraseInfoBuilder',
    'ISpeechRecoResultTimes', 'SpObjectToken', 'SAFT11kHz8BitMono',
    'DISPID_SRSetPropertyNumber', 'DISPID_SVEVoiceChange',
    'SGSDisabled', 'SRAInterpreter', 'SpeechRecognizerState',
    'SpInProcRecoContext', 'SpPhoneticAlphabetConverter',
    'SpeechCategoryVoices', 'SAFTNoAssignedFormat',
    'eLEXTYPE_RESERVED6', 'DISPID_SRCRetainedAudio',
    'DISPID_SLWPronunciations', 'DISPID_SLPPartOfSpeech',
    'SDA_Two_Trailing_Spaces', 'SASClosed', 'SPWORDPRONUNCIATIONLIST',
    'SRSEIsSpeaking', 'SFTSREngine', 'SWPUnknownWordUnpronounceable',
    'ISpStreamFormatConverter', 'DISPID_SRGIsPronounceable', 'SVP_6',
    'DISPID_SVEAudioLevel', 'SAFTGSM610_8kHzMono', 'SpeechAudioState',
    'SpStream', 'DISPID_SpeechPhraseRule', 'SpeechLexiconType',
    'ISpeechPhraseInfo', 'eLEXTYPE_PRIVATE18', 'SPGRAMMARWORDTYPE',
    'DISPID_SVEBookmark', 'DISPID_SRCResume', 'SPCONTEXTSTATE',
    'SpeechPropertyResponseSpeed',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SP_VISEME_7',
    'SAFTADPCM_8kHzMono', 'SpeechRegistryUserRoot',
    'DISPID_SRRRecoContext', 'SPRST_ACTIVE', 'LONG_PTR',
    'SPSERIALIZEDRESULT', 'DISPID_SVResume',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRGCmdSetRuleState',
    'eLEXTYPE_PRIVATE20', 'SpeechGrammarState', 'SAFT44kHz16BitMono',
    'SpeechRecoEvents', 'SAFT24kHz8BitMono',
    'DISPID_SPEDisplayAttributes', 'SAFT24kHz16BitStereo',
    'ISpPhoneticAlphabetConverter', 'SpeechFormatType',
    'SpeechTokenContext', 'SPPARTOFSPEECH', 'SpeechTokenShellFolder',
    'SpeechVoiceEvents', 'ISpObjectTokenCategory',
    'SpeechCategoryAudioIn', 'SRADefaultToActive', 'SPPS_RESERVED1',
    'SVP_8', 'SREAdaptation', 'SVEPrivate', 'SP_VISEME_2', 'SDTRule',
    'DISPID_SpeechLexiconWord', 'SAFT22kHz16BitMono',
    'DISPID_SASCurrentSeekPosition', 'ISpeechObjectTokens',
    'SpUnCompressedLexicon', 'DISPID_SPPNumberOfElements',
    'DISPID_SRRTOffsetFromStart', 'SpeechGrammarTagWildcard',
    'SAFT22kHz8BitStereo', 'SVESentenceBoundary', 'SREStreamStart',
    'SP_VISEME_4', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SpeechCustomStream',
    'SAFT32kHz8BitMono', 'SREAudioLevel',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SpeechPhraseReplacements', 'SpMMAudioOut',
    'ISpeechPhoneConverter', 'SPBO_PAUSE', 'DISPID_SRAudioInput',
    'DISPID_SRCCmdMaxAlternates', 'SPEI_SENTENCE_BOUNDARY',
    'SPCT_SLEEP', 'SAFT12kHz16BitMono', 'SPAS_PAUSE', 'SP_VISEME_10',
    'DISPID_SPRuleConfidence', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SOTs_NewEnum',
    'STSF_AppData', 'SpeechTokenKeyFiles', 'SPPS_NotOverriden',
    'SGLexicalNoSpecialChars', 'SREFalseRecognition',
    'SREStateChange', 'DISPID_SPISaveToMemory',
    'DISPID_SPAPhraseInfo', 'ISpeechGrammarRules', 'DISPID_SOTSetId',
    'DISPID_SPRuleEngineConfidence', 'SPAS_CLOSED',
    'DISPID_SPEPronunciation', 'SAFT12kHz8BitMono',
    'STSF_CommonAppData', 'SPDKL_LocalMachine', 'ISpRecoContext',
    'SPEI_HYPOTHESIS', 'DISPID_SRGDictationSetState',
    'DISPID_SMSAMMHandle', 'SPRECOSTATE', 'SWTDeleted',
    'SECFIgnoreKanaType', 'DISPID_SLGetGenerationChange',
    'SPSHT_Unknown', 'SpMMAudioEnum', 'SRTReSent', 'SPGRAMMARSTATE',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SDKDeleteValue',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SWFESamplesPerSec', 'DISPID_SRRTimes', 'SRTStandard',
    'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SVSFPurgeBeforeSpeak', 'SPSUnknown', 'SPSVerb',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SVSInputWordPosition', 'IInternetSecurityManager',
    'ISpDataKey', 'SRARoot', 'SAFT32kHz16BitMono', 'DISPID_SPPsItem',
    'SpAudioFormat', 'SSFMOpenReadWrite', 'SRTEmulated',
    'eLEXTYPE_RESERVED7', 'SAFTGSM610_44kHzMono',
    'DISPID_SPRuleChildren', 'SDTAudio', 'SPEI_RECO_OTHER_CONTEXT',
    'SVEStartInputStream', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SpeechRecoContext', 'DISPID_SVSInputWordLength',
    'DISPID_SRCPause', 'SPEI_START_INPUT_STREAM', 'SpeechMicTraining',
    'SVSFParseSsml', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRGSetTextSelection', 'SREStreamEnd', 'SPEI_PHRASE_START',
    'ISpeechResourceLoader', 'ISpVoice', 'SREPropertyStringChange',
    'DISPID_SPEAudioStreamOffset', 'SINoSignal', 'SVP_2',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRGDictationUnload',
    'SPINTERFERENCE_NOISE', 'SPSNotOverriden', 'DISPID_SBSSeek',
    'DISPID_SRCERecognizerStateChange', 'SPSHT_NotOverriden',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SRRGetXMLResult', 'SVP_0',
    'ISpRecognizer2', 'SpeechTokenValueCLSID', 'IEnumSpObjectTokens',
    'DISPID_SGRSTs_NewEnum', 'SpeechDisplayAttributes',
    'DISPID_SRCCreateGrammar', 'SPEVENTSOURCEINFO',
    'DISPID_SRCRequestedUIType', 'DISPID_SLGetPronunciations',
    'SpeechGrammarWordType', 'SP_VISEME_13', 'SAFTGSM610_11kHzMono',
    'SPVISEMES', 'SVSFParseMask', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SOTCEnumerateTokens', 'SASPause', 'eLEXTYPE_PRIVATE19',
    'SVP_13', 'DISPID_SRSNumberOfActiveRules', 'SGRSTTRule',
    'DISPID_SPRFirstElement', 'DISPID_SRCVoice', 'DISPID_SPRsCount',
    'SPPS_RESERVED4', 'SPWORDPRONUNCIATION',
    'DISPID_SAFGetWaveFormatEx', 'SpeechLoadOption',
    'DISPID_SGRSTsItem', 'Speech_StreamPos_Asap', 'SAFT22kHz8BitMono',
    'DISPID_SLWLangId', 'DISPID_SDKCreateKey',
    'ISpeechPhraseReplacement', 'SPFILEMODE', 'SGRSTTEpsilon',
    'ISpeechRecoResultDispatch', 'SpeechCategoryRecoProfiles',
    'SpCustomStream', 'DISPID_SWFEChannels',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SOTsItem', 'DISPID_SPPChildren', 'SPDKL_DefaultLocation',
    'DISPID_SPPEngineConfidence', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPRuleFirstElement', 'DISPID_SVEStreamStart',
    'DISPID_SVGetProfiles', 'DISPIDSPRG',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPRECORESULTTIMES',
    'SRERecoOtherContext', 'SPFM_OPEN_READWRITE', 'ISpXMLRecoResult',
    'SPEVENTENUM', 'eLEXTYPE_PRIVATE7', 'DISPID_SRRTLength',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SLPType',
    'DISPID_SOTGetAttribute', 'IEnumString',
    'DISPID_SpeechVoiceStatus', 'SPCS_ENABLED', 'eLEXTYPE_PRIVATE2',
    'DISPID_SDKDeleteKey', 'ISpProperties', 'SPPS_LMA',
    'SpeechGrammarTagUnlimitedDictation', 'SpInprocRecognizer',
    'UINT_PTR', 'SpNotifyTranslator', 'DISPID_SAStatus',
    'Speech_Default_Weight', 'SPBO_TIME_UNITS', 'ISpMMSysAudio',
    'SPPS_Noun', 'SASRun', 'SVSFNLPSpeakPunc', 'SPEI_MAX_SR',
    'DISPID_SRSClsidEngine', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SPRText', 'ISpeechDataKey', 'DISPID_SMSADeviceId',
    'DISPID_SGRAttributes', 'DISPID_SRCESoundEnd',
    'eLEXTYPE_PRIVATE5', 'DISPID_SCSBaseStream', 'DISPID_SAFType',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPEI_SR_BOOKMARK', 'SVP_19',
    'SVSFVoiceMask', 'SVF_Emphasis', 'ISpeechBaseStream',
    'SPVPRI_NORMAL', 'SRAImport', 'SpShortcut', 'DISPID_SRGRules',
    'ISpRecognizer', 'SAFTADPCM_44kHzStereo',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SOTDisplayUI',
    'SAFTADPCM_22kHzStereo', 'ISpeechPhraseProperty',
    'DISPID_SPIReplacements', 'eLEXTYPE_RESERVED8', 'SP_VISEME_11',
    'SPFM_CREATE', 'DISPID_SPRules_NewEnum', 'SPSERIALIZEDPHRASE',
    'DISPID_SLPsItem', 'SECNormalConfidence', 'SRAExport',
    'SpeechAudioProperties', 'SPWORDPRONOUNCEABLE',
    'SWPKnownWordPronounceable', 'SPAS_RUN',
    'SWPUnknownWordPronounceable', 'SRESoundEnd', 'DISPID_SLPLangId',
    'DISPID_SOTCreateInstance', 'SPINTERFERENCE_TOOSLOW', 'SPSMF_UPS',
    'SAFT8kHz16BitMono', 'DISPID_SVSkip', 'STCRemoteServer',
    'SPAUDIOSTATUS', 'ISpRecoGrammar', 'SAFT12kHz8BitStereo',
    'DISPID_SGRSTransitions', 'SpeechTokenKeyUI',
    'SAFTCCITT_uLaw_44kHzMono', 'SPEI_PHONEME',
    'SpeechRetainedAudioOptions', 'ISpeechAudioBufferInfo',
    'DISPID_SPEsItem', 'SP_VISEME_5', 'DISPID_SPRuleName',
    'SpeechVoicePriority', 'SPPS_Function', 'SPWORD',
    'SRSActiveAlways', 'DISPID_SLPPhoneIds', 'DISPID_SRRTStreamTime',
    'SPVOICESTATUS', 'DISPID_SpeechMMSysAudio', 'SPPS_RESERVED2',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SFSClose',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SRDisplayUI',
    'SAFTCCITT_ALaw_11kHzMono', 'SECFEmulateResult',
    'SVEWordBoundary', 'SpeechGrammarTagDictation',
    'tagSPPROPERTYINFO', 'SVSFDefault', 'DISPID_SRCERecognition',
    'DISPIDSPTSI', 'ISpeechCustomStream',
    'SpeechPropertyNormalConfidenceThreshold', 'eLEXTYPE_PRIVATE6',
    'SPEI_RESERVED1', 'DISPID_SpeechMemoryStream', 'eWORDTYPE_ADDED',
    'SpWaveFormatEx', 'SpeechCategoryAppLexicons', 'SVSFIsNotXML',
    'SPEI_VOICE_CHANGE', 'DISPID_SpeechAudioFormat', 'SPRS_INACTIVE',
    'DISPID_SRGetRecognizers', 'SPAUDIOBUFFERINFO', 'ISpAudio',
    'DISPID_SASState', 'SPCT_DICTATION', 'SPRST_INACTIVE',
    'SPBO_NONE', '_SPAUDIOSTATE', 'SpObjectTokenCategory',
    'DISPID_SVAudioOutputStream', 'SPPS_Interjection',
    'DISPID_SVEEnginePrivate', 'SAFTCCITT_ALaw_11kHzStereo',
    'ISpPhrase', 'SPEI_SR_AUDIO_LEVEL', 'SPAO_NONE', 'SPRULESTATE',
    'DISPID_SASFreeBufferSpace', 'SITooSlow', 'SRSInactiveWithPurge',
    'DISPID_SRCState', 'SVP_16', 'SPPHRASEELEMENT', 'SLOStatic',
    'DISPID_SRRSaveToMemory', 'ISpeechGrammarRuleState',
    'SPSModifier', 'SPGS_ENABLED', 'ISpeechPhraseAlternates',
    'ISpeechPhraseInfoBuilder', 'SLTUser', 'DISPID_SRRAudioFormat',
    'SP_VISEME_12', 'SpeechPropertyHighConfidenceThreshold',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPERequiredConfidence',
    'DISPID_SRGCmdSetRuleIdState', 'SVP_1', 'DISPID_SpeechVoiceEvent',
    'ISpeechLexicon', 'SPSHORTCUTPAIR',
    'DISPID_SLRemovePronunciation', 'DISPID_SPAs_NewEnum',
    'ISpStreamFormat', 'SVEViseme', 'SPPHRASEREPLACEMENT',
    'SREHypothesis', 'ISpRecoContext2', 'SpeechAudioVolume',
    'DISPID_SRCERequestUI', 'DISPID_SVSLastBookmark',
    'SDA_Consume_Leading_Spaces', 'SRSEDone', 'SDA_No_Trailing_Space',
    'DISPID_SDKGetBinaryValue', 'SGDSActiveUserDelimited',
    'SAFT48kHz8BitStereo', 'DISPID_SABIEventBias', 'SVSFlagsAsync',
    'DISPID_SpeechGrammarRule', 'SPPS_Verb',
    'DISPID_SWFEBitsPerSample', 'DISPID_SABIBufferSize', 'SVF_None',
    'ISpeechRecoResult', 'SVF_Stressed', 'SpLexicon', 'SASStop',
    'DISPID_SABIMinNotification', 'SRAONone', 'SpeechStreamFileMode',
    'DISPID_SPRulesCount', 'DISPID_SPEsCount', 'SPCT_COMMAND',
    'SPEI_PROPERTY_STRING_CHANGE', 'SAFT16kHz8BitMono',
    'DISPID_SRRDiscardResultInfo', 'eLEXTYPE_PRIVATE16',
    'SPLO_STATIC', 'ISpeechPhraseElements', 'SAFTCCITT_uLaw_8kHzMono',
    'eLEXTYPE_PRIVATE12', 'SGRSTTWildcard', 'DISPID_SVSLastResult',
    'SP_VISEME_20', 'SpeechInterference',
    'DISPID_SpeechLexiconPronunciation'
]

_check_version('1.2.0', 1698907374.266823)
